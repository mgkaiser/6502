...
/*
 * This block is to simulate a split phase clock like the real cpu.
 * The data is expected to be valid half a cycle after the address, 
 * not a full cycle. The clock is also inverted.
 * In other words, data is valid on falling edges and must be valid the
 * next rising edge, just like the real cpu.
 */
